...
export const CATALOG: CatalogDish[] = [
  ...
  { id: "d7", category: "Coffee", subtype: "Strong / Degree", name: "Degree Coffee", venue: "Vidyarthi Bhavan", score: 9.0, dietTags: ["veg"], allergens: ["dairy"] },
  { id: "d8", category: "Coffee", subtype: "Cold Filter Coffee", name: "Cold Filter Coffee", venue: "Third Wave Coffee", score: 8.1, dietTags: ["veg"], allergens: ["dairy"] },
